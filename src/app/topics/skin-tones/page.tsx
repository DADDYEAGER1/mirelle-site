      ...
      <div className="min-h-screen">
        ...
        <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img
              src="/skin-undertone-hero-diverse-hands-nail-polish.jpg"
        ...
        <section id="content" className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-16">
              ...
              <img
                src="/skin-undertone-chart-warm-cool-neutral-olive-comparison.jpg"
                alt="Complete undertone chart comparing warm, cool, neutral, and olive undertones across all skin depths from fair to deep"
                width={1200}
                height={800}
            ...
            <div id="quiz" className="mb-16">
              ...
              <div className="mb-12">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                  ...
                  <img
                    src="/skin-undertone-vein-test-wrist-comparison.jpg"
                    alt="Vein test showing blue veins indicating cool undertones and green veins indicating warm undertones on wrist"
                    width={800}
                    height={533}
              ...
              <div className="mb-12">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
                  ...
                  <img
                    src="/skin-undertone-jewelry-test-gold-silver-comparison.jpg"
                    alt="Jewelry test comparing gold and silver accessories to determine skin undertone by which metal looks more flattering"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full mb-6"
                  />
            ...
            <div id="nail-colors" className="mb-16">
              ...
              <div className="mb-12">
                <div className="bg-gradient-to-r from-orange-100 to-yellow-100 rounded-2xl p-8">
                  ...
                  <img
                    src="/skin-undertone-nail-polish-warm-tones-swatches-hands.jpg"
                    alt="Warm undertone nail polish swatches on diverse hands showing coral, peach, terracotta, and gold shades"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full mb-6"
                  />
              ...
              <div className="mb-12">
                <div className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl p-8">
                  ...
                  <img
                    src="/skin-undertone-nail-polish-cool-tones-swatches-hands.jpg"
                    alt="Cool undertone nail polish swatches on diverse hands showing berry, lavender, plum, and silver shades"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full mb-6"
                  />
