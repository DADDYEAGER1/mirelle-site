...
//                 </a>
//                 <a 
//                   href="https://twitter.com/mirelleinspo" 
//                   target="_blank" 
//                   rel="noopener noreferrer"
//                   className="text-gray-300 hover:text-blush-400 transition-colors"
...
//             <ul className="space-y-3">
//               <li>
//                 <Link href="/topics/chrome-nails" className="text-gray-300 hover:text-blush-400 transition-colors text-sm">
//                   Chrome Nails
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/topics/gel-nails" className="text-gray-300 hover:text-blush-400 transition-colors text-sm">
//                   Gel Nails
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/topics/press-on-nails" className="text-gray-300 hover:text-blush-400 transition-colors text-sm">
//                   Press-On Nails
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/topics/seasonal-trends" className="text-gray-300 hover:text-blush-400 transition-colors text-sm">
//                   Seasonal Trends
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/topics/nail-care" className="text-gray-300 hover:text-blush-400 transition-colors text-sm">
//                   Nail Care Tips
//                 </Link>
//               </li>
//             </ul>
...
//               <li>
//                 <a 
//                   href="mailto:hello@mirelleinspo.com"
//                   className="text-gray-300 hover:text-blush-400 transition-colors text-sm flex items-center"
//                 >
//                   <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//               <li>
//                 <a 
//                   href="mailto:advertising@mirelleinspo.com"
//                   className="text-gray-300 hover:text-blush-400 transition-colors text-sm flex items-center"
//                 >
//                   <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 mb-6">
              <li>
                <a 
                  href="mailto:team.mirelle@gmail.com?subject=Advertise%20Enquiry"
                  className="text-gray-300 hover:text-blush-400 transition-colors text-sm flex items-center"
                >
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
              ...
              <li>
                <a 
                  href="mailto:team.mirelle@gmail.com?subject=Get%20Featured%20Enquiry"
                  className="text-gray-300 hover:text-blush-400 transition-colors text-sm flex items-center"
                >
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              ...
              <li>
                <a 
                  href="mailto:team.mirelle@gmail.com?subject=Partnership%20Enquiry"
                  className="text-gray-300 hover:text-blush-400 transition-colors text-sm flex items-center"
                >
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
