...
export default function FeaturedTopicsSection() {
  return (
    <section id="featured-topics" className="py-20 bg-white">
          ...
          {topics.map((topic, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <div className="flex items-center text-white font-semibold group-hover:translate-x-2 transition-transform duration-300 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full w-fit">
                  Explore
                  <svg 
