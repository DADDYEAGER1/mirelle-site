module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // NEW: Your new brand colors (use these going forward)
        brand: {
          background: '#F7F7F7',
          text: '#252220',
          accent: '#E30088',
        ...
        // OLD: Keep these for backwards compatibility (remove after migration)
        burgundy: {
          50: '#fdf5f7',
          100: '#fce8ed',
          200: '#fad1db',
      ...
      fontFamily: {
        // NEW: Your new fonts (use these going forward)
