      ...
      <div className="min-h-screen">
        ...
        <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img
                    src="/images/topic/beginner-progression-simple-advanced-household-tools.webp"
                    alt="Beginner to advanced progression showing dots stripes gradients created with toothpicks tape sponges on manicured hands"
                    width={800}
                    height={533}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="supplies" className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  <img
                    src="/images/topic/household-essentials-toothpick-bobby-pin-tape-sponge-flatlay.webp"
                    alt="Flatlay of everyday household items toothpicks bobby pins scotch tape makeup sponges arranged for beginner manicure"
                    width={600}
                    height={400}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="nail-prep" className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  <img
                    src="/images/topic/preparation-clean-shaped-buffed-cuticles-pushed-back.webp"
                    alt="Prepped hands showing cleaned shaped buffed nails with gently pushed back cuticles ready for polish application"
                    width={600}
                    height={400}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
  ...
  <div className="flex items-start gap-3">
    ...
    <div className="flex-1">
      ...
      <p className="text-gray-600 text-sm">Same three strokes. Cap the tip (swipe across the very edge) to prevent chipping. Let dry 5 minutes before touching anything.</p>
                ...
                <img
                    src="/images/topic/single-color-smooth-application-bubble-free-technique.webp"
                    alt="Perfect single color manicure showing smooth bubble free application with clean cuticle lines and even coverage"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/glitter-gradient-sponge-dab-sparkle-fade-tips.webp"
                    alt="Sparkle gradient created by dabbing sponge with glitter polish from tips fading toward base for ombre effect"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/accent-ring-finger-contrasting-color-minimalist-style.webp"
                    alt="Minimalist manicure with four nails in nude and ring finger featuring bold contrasting burgundy accent color"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/geometric-color-block-tape-guide-clean-division.webp"
                    alt="Geometric design with two colors split diagonally using tape guide creating sharp clean line for modern look"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/scattered-dots-organic-placement-forgiving-pattern.webp"
                    alt="Random scattered dots in varying sizes placed organically across nails using toothpick for forgiving artistic look"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="super-easy" className="mb-16">
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/structured-polka-dots-evenly-spaced-grid-pattern.webp"
                    alt="Classic polka dots arranged in evenly spaced grid pattern created with toothpick showing consistent dot sizing"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/french-manicure-tape-guide-white-tips-pink-base.webp"
                    alt="Classic French manicure with pink base and white tips created using tape guide for perfect smile line curve"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/vertical-lines-metallic-tape-elongating-modern-style.webp"
                    alt="Vertical metallic striping tape on solid base creating elongating lines sealed with top coat for modern style"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/full-glitter-ombre-sponge-bounce-tip-to-base.webp"
                    alt="Full glitter gradient from dense tips fading to base created by bouncing loaded sponge for ombre sparkle effect"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
              ...
              <div className="mb-12">
                ...
                <img
                    src="/images/topic/two-color-blend-sponge-gradient-seamless-transition.webp"
                    alt="Two complementary colors blending seamlessly from tip to base using sponge technique for gradient ombre transition"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
