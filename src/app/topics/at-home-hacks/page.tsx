      ...
      <div className="min-h-screen">
        ...
        <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            <img
                    src="/images/topic/diy-nail-manicure-tools-polish-base-coat-setup.webp"
                    alt="Complete DIY nail manicure setup with polish bottles base coat top coat files and tools on clean white workspace surface"
                    width={800}
                    height={533}
            ...
            <div id="application" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/three-stroke-nail-polish-application-technique-diagram.webp"
                    alt="Diagram showing three stroke nail polish application method with center stroke left side and right side stroke technique"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/petroleum-jelly-cuticle-barrier-cleanup-hack.webp"
                    alt="Applying petroleum jelly barrier around cuticles with cotton swab for easy nail polish cleanup and mess free manicure"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/sealing-nail-free-edge-prevent-chipping-technique.webp"
                    alt="Sealing nail free edge with polish brush horizontally across tip to prevent chipping and extend manicure wear time"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="quick-dry" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/ice-water-bowl-quick-dry-nail-polish-method.webp"
                    alt="Bowl filled with ice water for quick drying nail polish method showing hands dipping painted nails into cold water"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="longevity" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/reapplying-top-coat-extend-manicure-longevity.webp"
                    alt="Reapplying clear top coat over existing manicure every few days to seal polish restore shine and extend wear time"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="mistakes" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/fixing-smudged-nail-polish-cotton-swab-remover.webp"
                    alt="Using cotton swab dipped in nail polish remover to smooth and blend smudged nail polish area before reapplying coat"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="household-tools" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/scotch-tape-geometric-stripe-nail-art-design.webp"
                    alt="Creating perfect geometric stripe nail art using scotch tape as guide for clean lines and professional looking designs"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/makeup-sponge-ombre-gradient-nail-blending-technique.webp"
                    alt="Using makeup sponge to create ombre gradient nail effect by dabbing multiple polish colors for smooth blended design"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="nail-art" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/newspaper-print-transfer-nail-art-rubbing-alcohol.webp"
                    alt="Newspaper print transfer nail art technique using rubbing alcohol to transfer text and images onto painted nail surface"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="removal" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/glass-nails-ultra-glossy-translucent-finish-effect.webp"
                    alt="Glass nails effect showing ultra glossy translucent finish achieved with sheer polish and mirror shine top coat look"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
            ...
            <div id="trending" className="mb-16">
              ...
              <div className="space-y-10">
                ...
                <div className="glass-card p-8 rounded-2xl">
                  ...
                  <img
                    src="/images/topic/aluminum-foil-glitter-polish-removal-acetone-wrap.webp"
                    alt="Aluminum foil wrapped around fingers with acetone soaked cotton pads for easy glitter nail polish removal technique"
                    width={800}
                    height={533}
                    className="rounded-xl shadow-lg w-full max-w-2xl mx-auto mb-4"
                  />
